...
public class RuleBackListLogicFilter implements ILogicFilter<RuleActionEntity.RaffleBeforeEntity> {
    ...
    public RuleActionEntity<RuleActionEntity.RaffleBeforeEntity> filter(RuleMatterEntity ruleMatterEntity) {
        // 检查ruleMatterEntity是否为空
        if (ruleMatterEntity == null) {
            log.error("RuleMatterEntity is null.");
            throw new IllegalArgumentException("RuleMatterEntity cannot be null");
        }
        ...
        if (ruleValue == null || ruleValue.isEmpty()) {
            log.warn("Rule value is empty or null.");
